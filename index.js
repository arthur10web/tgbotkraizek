...
const TOKEN ='5504170222:AAGaWJXpgUyyNR3MX1vw2Ga24ivn8CT-CEc'
...
bot.on('message',msg =>{
    ...
    if(text === '/help'){
     ...
     if(text === '/test'){
        ...
        //  })
        return bot.sendMessage(chatId,'https://drive.google.com/uc?export=download&confirm=no_antivirus&id=1c9F0GGgAObD8JofJCJmhNY5IPX2oS4GS')
    //1V79wzs28UaGBlvcsTprroyCgT-Yof-zz  https://drive.google.com/uc?export=download&confirm=no_antivirus&id=1xopbSSoAemQ4VRYpT4bFKjiamTc2jbB9'
     }//https://drive.google.com/file/d/1c9F0GGgAObD8JofJCJmhNY5IPX2oS4GS/view?usp=sharing
})
}
start()